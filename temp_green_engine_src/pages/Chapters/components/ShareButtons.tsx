...
export const ShareButtons = ({ chapter }: ShareButtonsProps) => {
  const currentUrl = window.location.href;
  const shareText = `Check out "${chapter.title}" from MicroHarvest`;
  ...
  return (
    <div className="flex items-center gap-3 mt-8 pt-6 border-t border-gray-200">
      <span className="text-sm font-medium text-gray-600">Share this chapter:</span>
